...
class TestCommonPageStructureAuthed():
    ...
    def page(self, browser, new_user, page_url, ex_page_name):
        yield setup_page(Common, browser, page_url)
    ...
    def test_cs50logo_is_visible(self, page):
        ...
        assert page.get_cs50_logo() == CS50_LOGO, (
            f"Page Logo in the navigation bar (sum of spans inside the default page link) doesnt spell {CS50_LOGO}"
            )
