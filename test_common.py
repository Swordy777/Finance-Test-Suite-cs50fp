...
@pytest.mark.parametrize("page_url, page_name", AUTHED_PAGES)
class TestCommonPageStructureAuthed():
    def test_page_title_is_correct(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
        page_title = page.get_page_title()
        assert page_title == page_name, (
            f"Expected page title to be {page_name}, actual title: {page_title}")
        
    def test_has_link_to_the_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
        page.should_have_default_link()

    def test_cs50logo_is_visible(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
        page.should_have_cs50_logo()

    def test_nav_items_are_present(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
        page.should_have_nav_items()

    def test_no_register_menu_item(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_no_login_menu_item(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_has_logout_menu_item(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
...
@pytest.mark.parametrize("page_url, page_name", UNAUTHED_PAGES)
class TestCommonPageStructureUnauthed():
    def test_register_page_title_is_correct(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
        page_title = page.get_page_title()
        assert page_title == page_name, (
    ...
    def test_has_no_nav_items(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_has_login_menu_item(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
        login_menu_item = page.get_login_link()
        assert login_menu_item is not None, "Expected 'Log in' navigation item to be present on register page"

    def test_has_no_logout_menu_item(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
        logout_menu_item = page.get_logout_link()
...
class TestCommonNavigation():
    def test_go_to_quote_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_go_to_buy_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_go_to_sell_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_go_to_history_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_go_to_login_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_go_to_register_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
    ...
    def test_go_to_logout_page(self, browser, page_url, page_name):
        page = BasePage(browser, page_url)
        page.open()
